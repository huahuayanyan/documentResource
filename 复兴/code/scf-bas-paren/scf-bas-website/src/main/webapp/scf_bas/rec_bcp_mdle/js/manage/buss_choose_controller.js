...
var BussChooseController =  function(dialogScope,parentScope,$common,dataDeliver,$state,row){
    ...
    //获得之前得到的卖方客户号去查询  业务合同号，业务品种名称和id，对应的合同的币种
       ...
       dialogScope.debtContnoContent = {
            ...
            param:{custcd:dialogScope.otherform.custcdSaller,financingType:"1"},
            split:"",//分隔符*/
        ...
        dialogScope.debtContnoExtent = function(ds){
            ...
            if(ds.supplyChainPdId=="1230010"){
                dialogScope.otherform.factType='1';
            }else if(ds.supplyChainPdId=="1230020"){
                dialogScope.otherform.factType='2';
            }else if(ds.supplyChainPdId=="1230030"){
                dialogScope.otherform.factType='6';
            }
        ...
        dialogScope.buyerContent = {
            ...
            param:{businessNo:dialogScope.otherform.mastContno},//请求参数,如果不写该属性或者param:{},则以输入当前字段查
            split:"",//分隔符*/
