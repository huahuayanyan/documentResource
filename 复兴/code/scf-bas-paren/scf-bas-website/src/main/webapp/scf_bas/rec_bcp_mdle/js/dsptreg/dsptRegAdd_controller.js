...
var dsptRegAddController = function($scope,$common,dataDeliver,$state,$stateParams,$compile,$eventCommunicationChannel) {
    ...
    $scope.otherform.ext2="应收账款商纠登记申请";
    //买方客户查询
    $scope.buyerContent = {
    ...
    $scope.save_onClick= function(){
        if($.doValidate("cntDebtInfoForm")){//实际上这里还需要再去后台检验下客户名称和客户号是否一致 todo!!!!
            ...
            if(flag){//保存操作
                ...
                var processModel = {
                    modelId: 'DisputeInvoiceSetApply',
                    ProcessName: '应收账款商纠登记申请',
                    NodeId: 'DisputeInvoiceSetSave',
