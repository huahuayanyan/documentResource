...
public class BatchConstant {
	...
	public static final String BATCH_PROPERTY_EXPORT_TABLE_SHELL =
		"ExportTableShell";
	public static final String BATCH_PROPERTY_SHELL_PATH = "ShellPath";
	public static final String BATCH_PROPERTY_PERSONAL_CREDIT_PATH =
		"PersonalCreditPath";

	public static final String BATCH_PROPERTY_SHELL_CMD = "ShellCmd";

	public static final String BATCH_PROPERTY_TFTP_REMOTE_PATH_HOST = "RemoteHost";
	public static final String BATCH_PROPERTY_TFTP_REMOTE_PATH_APP = "RemoteApp";
	/**
	 * 备份
	 */
	public static final String BATCH_PROPERTY_BACKUPFILE_SHELL =
		"BackupFileShell";
	/**
	 * 清表
	 */
	...
	public static final String BATCH_PROPERTY_SMS_ALTER_DAYS =
		"SmsRepayPlanWarnDays";
	/**
	 * 批量倒出表数据文件存放路径
	 */
	public static final String BATCH_PROPERTY_EXPORT_TABLE_PATH =
		"ExportTablePath";
	/*
	 * 报表运行周期,目前用于质量迁徙表
	 */
 ...
 */
	 ...
	 * 主机下来的批量文件存放路径
	 */
	public static final String BATCH_HOST_SOURCE_FILE_PATH =
		"HostSourceFilePath";
	public static final String BATCH_IBP_SOURCE_FILE_PATH =
		"IBPUpFilePath";
	/**
	 ...
	 */
	public static final String BATCH_PROPERTY_REPORT_GEN_PATH =
		"batchReportGenPath";
	/**
	 * #　批量报表模版　*.jasper文件路径
	 */
	public static final String BATCH_PROPERTY_JASPER_FILE_PATH =
		"batchReportJasperFilePath";
	...
	* 批量配置文件属性：批量报表文件打包路径
	*/
	public static final String BATCH_PROPERTY_REPORT_TAR_PATH =
		"batchReportTarPath";

	//	释放所有被锁住的资源-BoCom00018160
	public static final String BATCH_PROPERTY_FORCE_APPLICATION_SHELL =
		"ForceApplicationShell";
	...
	/** add by shen_antonio 20100605 JIRA: BMS-2771  begin .*/
	/**
	 * 数据库连接方式
	 */
	public static final String BATCH_PROPERTY_DataBase_CONN_TYPE = "DataBase_CONN_TYPE";

	/**
	* @Fields BATCH_PROPERTY_DataBase_CONN_TYPE_1 :  数据库连接方式:使用批量中连接池
	*/
	public static final String BATCH_PROPERTY_DataBase_CONN_TYPE_1 = "1";

	/**
	* @Fields BATCH_PROPERTY_DataBase_CONN_TYPE_2 : 数据库连接方式:使用批量中连接，非连接池
	*/
	public static final String BATCH_PROPERTY_DataBase_CONN_TYPE_2 = "2";

	/**
	* @Fields BATCH_PROPERTY_DataBase_CONN_TYPE_3 : 数据库连接方式: 使用联机中联机池
	*/
	public static final String BATCH_PROPERTY_DataBase_CONN_TYPE_3 = "3";
	/**
	 * @Fields BATCH_PROPERTY_DataBase_CONN_TYPE_3 : 数据库连接方式: 使用联机中联机池
	 */
	public static final String BATCH_PROPERTY_DataBase_CONN_TYPE_4 = "4";

	/**
	* @Fields BATCH_PROPERTY_DataBase_Application_Server_Context_Class : 联机应用上下文类路径,数据库连接方式为[3]时有效
	*/
	public static final String BATCH_PROPERTY_DataBase_Application_Server_Context_Class = "DataBase_Application_Server_Context_Class";

	/**
	* @Fields BATCH_PROPERTY_DataBase_Application_Server_DataSource_BeanName : 联机应用数据源BeanName,数据库连接方式为[3]时有效
	*/
	public static final String BATCH_PROPERTY_DataBase_Application_Server_DataSource_BeanName = "DataBase_Application_Server_DataSource_BeanName";

	/** add by shen_antonio 20100605 JIRA: BMS-2771  end .*/

	/**
	 * 备份数据库用户
	 */
	public static final String BATCH_PROPERTY_BACKUP_USER = "Backup_UserID";
	public static final String BATCH_PROPERTY_BACKUP_PASSWORD =
		"Backup_Password";
	public static final String BATCH_PROPERTY_BPEDBBACKUP_USER =
		"BPEDBBackup_UserID";
	public static final String BATCH_PROPERTY_BPEDBBACKUP_PASSWORD =
		"BPEDBBackup_Password";
	 ...
	 * 文件头栏位开始列位置
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_HEAD_FIELD_BEGIN_POSITION =
		"begin";
	/**
	 * 文件头栏位终止列位置
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_HEAD_FIELD_END_POSITION =
		"end";
	/**
	 * 文件名标签
	 */
	 ...
	 * 转换数据源文件
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_SOURCEFILE =
		"sourceFile";
	/**
	 * 数据源文件前缀
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_SOURCEFILE_PREFIX =
		"sourceFilePrefix";
	/**
	 * 最小保证字段数目
	 */
	 ...
	 * 目标存放文件
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_TARGETFILE =
		"targetFile";
	/**
	 * 目标表
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_TARGETTABLE =
		"targetTable";
	/**
	 *  是否删除临时表
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_DELETE_TEMP =
		"deleteTempTable";
	/**
	 * 删除CONDITION
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_CONDITION =
		"hasDeleteCondition";
	/**
	 * 文件TXDATE
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_TXDATE =
		"hasFileTxdate";

	/**
	 * 是否EBCD码
	*/
	public static final String BATCH_CONVERT_FILE_XML_FILE_EBCD =
				"isEBCD";

	/**
	 * 可忽律错误行数
	*/
	public static final String BATCH_CONVERT_FILE_XML_FILE_SKIPERROWNUMS =
					"skipErrRowNums";

	/**
	 * 字段分隔符
	 */
	public static final String BATCH_CONVERT_FILE_XML_FILE_SEPARATOR =
		"separator";
	/**
	 * 字段标签
	 */
	 ...
	 * 总控线程名称
	 */
	public final static String GENERAL_CONTROL_THREAD_NAME =
		"GeneralControlThread";
	/**
	 * 系统默认数据库commit笔数
	 */
	 ...
	 * 全局数据表ID
	 */
	public static final String TABLE_GLOBAL_INFO_ID="47a734a490cb493abf9a44820c270d14";
	 ...
	 * 打包并且压缩数据
	 */
	public static final String BATCH_PROPERTY_DISPENSE_DATA_TAR_COMPRESS =
		"DispenseDataTarCompress";
	 ...
	 *
	 */
	public static final String BATCH_PROPERTY_TFTP = "Tftp";
	/*
	 * 数据抽取 add by karas @ 20091019
	 */
	public static final String BATCH_PROPERTY_EXTRACT = "Extract";
	public static final String BATCH_PROPERTY_EXTRACT_FTP = "Ftp";
	/**
	  * 下发数据路径
	  */
	...
	/**
	  * 创建路径
	  */
	public static final String BATCH_PROPERTY_DISPENSE_CREATE_PATH =
		"DispenseCreatePath";
	 ...
	 * 无锡公积金数据文件所在目录
	 */
	public static final String BATCH_PROPERTY_IMPORTDATA_PATH =
		"ImportDataPath";
	/*
	 * 年终利率浮动主机文件所在目录
	 */
	public static final String BATCH_PROPERTY_FLTINTRATE_PATH =
		"HostFltintrateFilePath";
	...
	//后台线程开始运行延迟时间(秒)
	public static final String ONLINE_BATCH_SCHEDULER_DELAY =
		"onlinebatch_scheduler_delay";
	//后台线程运行间隔时间(秒)
	public static final String ONLINE_BATCH_SCHEDULER_PEROID =
		"onlinebatch_scheduler_period";
	//队列长度
	public static final String ONLINE_BATCH_QUEUE_CAPACITY =
		"onlinebatch_queue_capacity";
	//联机批量最大并发数
	public static final String ONLINE_BATCH_CONCURRENT_COUNT =
		"onlinebatch_concurrent_count";

	public static final String ONLINE_BATCH_LOG_FILE = "OnlineBatchLog";
	/**
	  * 现金回增上传数据路径
	 */
	public static final String BATCH_PROPERTY_UPLOAD_DATA_PATH =
		"UploadDataPath";
	...
	//忽略联机状态
	public final static String BH_JOB_INFO_RUNONLINE_INGNORE = "2";
	...
	public static final String FILE_TYPE_NET = "etl"; // 文件类型为1-网银
	public static final String FILE_TYPE_CORE = "host"; // 文件类型为2-核心
	public static final String FILE_TYPE_ARMS = "etl"; // 文件类型为3-风管
	//add by hui.liu 20110916
	public static final String FILE_TYPE_CMSF = "CMSF"; // 文件类型为4-信贷
	public static final String CORE_FILE_PREPERT_KEY_HOST_IP = "down.host.ip"; //文件服务器IP
	public static final String CORE_FILE_PREPERT_KEY_HOST_PORT = "down.host.port"; //端口号
	public static final String CORE_FILE_PREPERT_KEY_DOWN_BASE_PATH = "core.file.down.base.path"; //文件服务器存放路径父目录

	public static final String BATCH_PROPERTY_CORE_NET_URL = "core.net.url";//网关地址
	public static final String BATCH_PROPERTY_CORE_CONN_TIMEOUT = "core.conn.timeout";//连接超时
	public static final String BATCH_PROPERTY_CORE_SOCKET_TIMEOUT = "core.socket.timeout";//Socket超时

	public static final String BATCH_PROPERTY_HTTPFILE_NET_URL = "bhhttpfile.net.url";//日终文件处理失败后处理地址


	//////////////20090816yuangx 补充,将SystemConstant 里面的与业务系统无关的批量全局变量移植到BatchConstant中.SystemConstant满足完全只定义业务系统变量.
	 ...
	 * 缺省用户密码加密密钥
	 */
	public static final String DEFAULT_PASSWORD_KEY = "Huateng.bocompl.Ocean's Fourteen.DWMNTH2CJFLCWL";
	...
	public static final String IF_STATUS_CHANGE_DATE = "00"; //00-核心换日
	public static final String IF_STATUS_DOWNLOAD_CORE = "01"; //01-核心数据下发成功
	public static final String IF_STATUS_DOWNLOAD_ARMS = "02"; //02-风管数据下发成功
	...
	public static final String ENTITY_REGISTER_BUSTYPE_ACCEPT = "01";//01-承兑登记
	public static final String ENTITY_REGISTER_BUSTYPE_CLOSED = "09";//09-票据结清

	/* Added by gp lv */
	/** 纸票登记表 来源字段 0-人工 */
	public static final String ENTITY_REGISTER_SRC_TYPE_HAND = "0";
	/** 纸票登记表 来源字段 1-批量 */
	public static final String ENTITY_REGISTER_SRC_TYPE_BATCH = "1";

	/*
	 * JOB 的MISC域；用于表示作业是日终批量还是日初批量
	 */
	public static final String JOB_TYPE_END = "1" ; //作业状态，1-日终批量
	public static final String JOB_TYPE_START = "2" ; //作业状态，2-日初批量

	/**
	 * 数据仓库服务器FTP信息
	 * add by karas 20081115
	 */
	public static final String DATAHOST_IP = "DATAHOST_IP";
	public static final String DATAHOST_FTP_PORT = "DATAHOST_FTP_PORT";
	public static final String DATAHOST_FTP_USERNAME = "DATAHOST_FTP_USERNAME";
	public static final String DATAHOST_FTP_PWD = "DATAHOST_FTP_PWD";
	public static final String DATAHOST_FTP_PATH = "DATAHOST_FTP_PATH";
	 ...
	 * add by karas 20081115
	 */
	public static final String ETLHOST_IP = "ETLHOST_IP";
	public static final String ETLHOST_FTP_PORT = "ETLHOST_FTP_PORT";
	public static final String ETLHOST_FTP_USERNAME = "ETLHOST_FTP_USERNAME";
	public static final String ETLHOST_FTP_PWD = "ETLHOST_FTP_PWD";
	public static final String ETLHOST_FTP_PATH = "ETLHOST_FTP_PATH";
	 ...
	 * 生成核算文件存放路径
	 */
    public static final String BATCH_TLA_ACE_FILE_PATH = "tlaBatchFilePath";


    /**
	 * 主机-核心系统处理过返回文件存放路径
	 */
    public static final String BATCH_ACE_RESULT_FILE_PATH = "aceResultFilePath";

    /**
	 * 日切后核算是否有日切标志
	 * 指的是：在核算部分批处理时，如果系统轮询检查到到核心日切标志时，本系统日切后的批量要做日切标志
	 */
    public static final String ACE_SWITCH_DAY_FLAG_YES="1";  //表示该核算部分的批量在核算日切后
    public static final String ACE_SWITCH_DAY_FLAG_NO="0";   //表示该标志不是核算日切后的批量

    public static final String ACE_SWITCH_DAY_FLAG="ACE";  //记录在bh_proc_log表的ACE_SWITCH_STA

//    public static final String ACE_USE_FTP_HOSTIP="FTPHost_IP";  //核算上传文件要放的FTP的IP
//    public static final String ACE_USE_FTP_USERID="FTP_UserID";//FTP登录的ID
//    public static final String ACE_USE_FTP_PASSWORD="FTP_Password";//FTP登录密码
//    public static final String ACE_CREATE_FILE_TMP_PATH="FTP_CreateFile_Path"; //核算生成文件上传到FTP上的路径

    public static final String ACE_USE_HOSTIP="Host_IP"; // 核心主机IP
    public static final String ACE_USE_HOSTPORT="Host_PORT"; //核心主机端口号

    public static final String HOST_GD_DQDH="Host_dqdh";//虚拟地区代号
    public static final String HOST_GD_JGDH="Host_jgdh";//虚拟机构代号
    public static final String HOST_GD_JYGY="Host_jygy";//虚拟交易柜员
    public static final String HOST_GD_ZDDH="Host_zddh";//虚拟终端代号

    /**
     * 用于SOCKET服务端口设置
     */

//    public static final String BATCH_HOST_IP="HOST_socket_Server_ip";
//    public static final String BATCH_HOST_PORT="HOST_socket_Server_port";

    /*********************************             SCF动产融资 系统常量 BEGIN             **************************************************/
    /**
	 * 批量配置文件属性：批量日志存放路径
	 */
	public static final String INITIAL_FILE_PATH = "initialFilePath";

	/**
	 * 批次成功时返回0（集中作业平台需要）
	 */
	public static final String THREAD_STATUS_SUCCESS = "0";

	/**
	 * 从合同类型 01-保证
	 */
	public static final String SLAVE_CONT_TYPE_01 = "01";
	/**
	 * 从合同类型 02-抵押
	 */
	public static final String SLAVE_CONT_TYPE_02 = "02";
	/**
	 * 从合同类型 03-质押
	 */
	public static final String SLAVE_CONT_TYPE_03 = "03";

	/**
	 * 机构有效状态
	 */
	public static final String  BCTL_STATUS_VALID ="1";
	public static final String  BCTL_STATUS_INVALID ="0";
