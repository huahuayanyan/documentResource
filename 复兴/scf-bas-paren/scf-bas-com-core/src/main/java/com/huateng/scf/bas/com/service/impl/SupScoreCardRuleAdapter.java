 ...
 */
@ScubeService
@Service("supScoreCardRuleAdapter")
public class SupScoreCardRuleAdapter implements IScfAbsAdapter{
	...
	public List<? extends IScfAbsOutput> process(IScfAbsInput<? extends IScfAbsInput> params) throws ScubeBizException {
		...
		inputParams.put(ScfBasConstant.RULES_SET_VERSION,
				ScfMessageUtil.transSysMsgByKey(ScfBasConstant.RULES_SET_VERSION_SUPSCORECARD));// 规则集版本
