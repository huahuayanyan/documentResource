...
public class BCntDebtExtInfo extends ScfBaseModel implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        BCntDebtExtInfo other = (BCntDebtExtInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getBusinessNo() == null ? other.getBusinessNo() == null : this.getBusinessNo().equals(other.getBusinessNo()))
            && (this.getBuyerCustcd() == null ? other.getBuyerCustcd() == null : this.getBuyerCustcd().equals(other.getBuyerCustcd()))
