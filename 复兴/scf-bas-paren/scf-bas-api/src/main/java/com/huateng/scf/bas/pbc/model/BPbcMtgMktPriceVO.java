...
public class BPbcMtgMktPriceVO implements Serializable {
	...
	public boolean equals(Object that) {
		...
		BPbcMtgMktPriceVO other = (BPbcMtgMktPriceVO) that;
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				...
				&& (this.getMortgageThreeName() == null ? other.getMortgageThreeName() == null
						: this.getMortgageThreeName().equals(other.getMortgageThreeName()))
