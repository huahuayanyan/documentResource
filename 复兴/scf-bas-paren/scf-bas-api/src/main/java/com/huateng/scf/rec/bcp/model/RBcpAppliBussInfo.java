...
public class RBcpAppliBussInfo extends RBcpExt implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				...
				&& (this.getBalanceAccount() == null ? other.getBalanceAccount() == null : this.getBalanceAccount().equals(other.getBalanceAccount()))
				...
				&& (this.getCoreAccount() == null ? other.getCoreAccount() == null : this.getCoreAccount().equals(other.getCoreAccount()))
				...
				&& (this.getLastUptTime() == null ? other.getLastUptTime() == null : this.getLastUptTime().equals(other.getLastUptTime()))
				...
				&& (this.getRefundTerm() == null ? other.getRefundTerm() == null : this.getRefundTerm().equals(other.getRefundTerm()))
				&& (this.getPayee() == null ? other.getPayee() == null : this.getPayee().equals(other.getPayee()))
				&& (this.getRefundAcctNo() == null ? other.getRefundAcctNo() == null : this.getRefundAcctNo().equals(other.getRefundAcctNo()))
