 ...
 *            </pre>
 */
public interface IRBcpDebtBussInfoService {
	public static final String BEAN_ID = "rBcpDebtBussInfoService";

	// 新增应收账款单据基本信息，同时也新增应收账款单据明细信息
	public String addRBcpDebtBussInfo(@ScubeParam("rBcpDebtBussInfo") RBcpDebtBussInfo rBcpDebtBussInfo);
	...
	public RBcpDebtBussInfo findRBcpDebtBussInfoByKey(
			@ScubeParam("rBcpDebtBussInfo") RBcpDebtBussInfo rBcpDebtBussInfo);
	...
	public RBcpDebtBussInfo saveDebtOutPoolInfo(@ScubeParam("debtVO") DebtBussInfoVO debtVO,@ScubeParam("applyTypeOutPool") java.lang.String applyTypeOutPool);
	/**
	 * 
	 * @param debtVO
	 * @param applyType
	 ...
	 * @return
	 */
	public Page queryDebtRepaymentInfo(@ScubeParam("commonQueryVO")DebtCommonQryVO commonQueryVO,@ScubeParam("pageSize") int pageSize,@ScubeParam("pageNo") int pageNo);
