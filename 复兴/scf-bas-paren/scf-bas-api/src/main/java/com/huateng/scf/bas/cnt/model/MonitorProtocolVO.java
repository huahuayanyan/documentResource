 ...
 * </pre>
 */
public class MonitorProtocolVO implements Serializable{
	...
	public String toString() {
		return "MonitorProtocolVO [protocolNo=" + protocolNo + ", protocolCode=" + protocolCode + ", productId="
				+ productId + ", moniType=" + moniType + ", curcdNm=" + curcdNm + ", secCd=" + secCd + ", secName="
				+ secName + ", thrName=" + thrName + ", thrCode=" + thrCode + ", startDate=" + startDate + ", endDate="
				+ endDate + ", sellOffFlag=" + sellOffFlag + ", isPledge=" + isPledge + ", state=" + state
				+ ", cooperationBrcode=" + cooperationBrcode + ", cooperationBrcodeNm=" + cooperationBrcodeNm
				+ ", tlrNo=" + tlrNo + ", tlrName=" + tlrName + ", brcode=" + brcode + ", brcodeNm=" + brcodeNm
				+ ", warehouseType=" + warehouseType + ", priceDropRate=" + priceDropRate + ", logisticsMoniCondition="
				+ logisticsMoniCondition + ", levels=" + levels + ", monitorArea=" + monitorArea + ", monitortype="
				+ monitortype + ", detailMonitorArea=" + detailMonitorArea + ", limitSum=" + limitSum
				+ ", monitorStatus=" + monitorStatus + ", levelCogniDate=" + levelCogniDate + ", levelEndDate="
				+ levelEndDate + ", otherDes=" + otherDes + ", custcd=" + custcd + ", slaveContno=" + slaveContno + "]";
	}
