...
public class DeliveryQryVO extends CommonQryVO {
	...
	public DeliveryQryVO(String coreCustcd, String fouCd, String debetNo, String startDate1, String startDate2, BigDecimal amount1,
			BigDecimal amount2, String appno, String loanWay, String startDate, String startDate3, String startDate4, String tradeContno,
			String status, String debetId, String coreNm, String buyBackNm, String bussTypeName, String operationType, String businessNo, String id,
			String state) {
