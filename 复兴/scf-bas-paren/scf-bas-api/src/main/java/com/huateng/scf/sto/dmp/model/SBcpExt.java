package com.huateng.scf.sto.dmp.model;

import java.io.Serializable;
import java.math.BigDecimal;
import java.util.Date;

import com.huateng.scf.bas.pbc.model.BPbcAppliExt;

public class SBcpExt extends BPbcAppliExt implements Serializable{
	/**
	 * 
	 */
