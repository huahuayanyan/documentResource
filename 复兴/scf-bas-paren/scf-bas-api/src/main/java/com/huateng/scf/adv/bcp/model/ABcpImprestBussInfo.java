...
public class ABcpImprestBussInfo implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", configNo=").append(configNo);
    ...
    public boolean equals(Object that) {
        ...
        ABcpImprestBussInfo other = (ABcpImprestBussInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getConfigNo() == null ? other.getConfigNo() == null : this.getConfigNo().equals(other.getConfigNo()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getConfigNo() == null) ? 0 : getConfigNo().hashCode());
