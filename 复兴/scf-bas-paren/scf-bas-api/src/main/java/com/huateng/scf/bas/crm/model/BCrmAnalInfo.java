...
public class BCrmAnalInfo implements Serializable {
	...
	public void setRegisterN(String registerN) {
	...
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				...
				&& (this.getAnalDate() == null ? other.getAnalDate() == null
						: this.getAnalDate().equals(other.getAnalDate()))
				&& (this.getManageQual() == null ? other.getManageQual() == null
						: this.getManageQual().equals(other.getManageQual()))
				&& (this.getMarketEnvir() == null ? other.getMarketEnvir() == null
						: this.getMarketEnvir().equals(other.getMarketEnvir()))
				&& (this.getRemarks() == null ? other.getRemarks() == null
						: this.getRemarks().equals(other.getRemarks()))
				&& (this.getRegister() == null ? other.getRegister() == null
						: this.getRegister().equals(other.getRegister()));
	}
