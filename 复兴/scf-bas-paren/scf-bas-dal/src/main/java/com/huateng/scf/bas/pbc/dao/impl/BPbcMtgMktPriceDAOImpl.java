...
@Repository("IBPbcMtgMktPriceDAO")
public class BPbcMtgMktPriceDAOImpl extends IbatisDaoAnnotation4Template implements IBPbcMtgMktPriceDAO {
	@Resource(name = "sqlMapClientTemplate")
	private IbatisTemplate template;

	public BPbcMtgMktPriceDAOImpl() {
		super();
	}
	...
	@Override
	public BPbcMtgMktPrice selectObjectByPrimaryKey(BPbcMtgMktPriceExample example) {
		// BPbcMtgMktPrice bPbcMtgMktPrice = new BPbcMtgMktPrice();
		BPbcMtgMktPrice bPbcMtgMktPrice = this.selectObjectByPrimaryKey(example);
		return bPbcMtgMktPrice;
	}
}