...
public class BSysUploadFile implements Serializable {
    ...
    public void setFilePro(String filePro) {
        this.filePro = filePro == null ? null : filePro.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", filePro=").append(filePro);
    ...
    public boolean equals(Object that) {
        ...
        BSysUploadFile other = (BSysUploadFile) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFilePro() == null ? other.getFilePro() == null : this.getFilePro().equals(other.getFilePro()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFilePro() == null) ? 0 : getFilePro().hashCode());
