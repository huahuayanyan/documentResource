...
@Repository("IRBcpAppliRepaymentDAO")
public class RBcpAppliRepaymentDAOImpl extends IbatisDaoAnnotation4Template implements IRBcpAppliRepaymentDAO {
    ...
    @SuppressWarnings("unchecked")
    @Override
	public List<RBcpAppliRepayment> selectByRBcpAppliRepaymentByAppno(String appno)
    {
    	RBcpAppliRepayment key = new RBcpAppliRepayment();
    	key.setAppno(appno);
    	List<RBcpAppliRepayment> list = getSqlMapClientTemplate().queryForList("EXT_R_BCP.selectByRBcpAppliRepaymentByAppno", key);
        return list;
    }
}