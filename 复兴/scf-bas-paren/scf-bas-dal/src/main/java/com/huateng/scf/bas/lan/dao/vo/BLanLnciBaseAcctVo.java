package com.huateng.scf.bas.lan.dao.vo;

import java.io.Serializable;
import java.math.BigDecimal;
import java.util.Date;

public class BLanLnciBaseAcctVo implements Serializable {
	
	private String bailAccountno;
	private BigDecimal addNewBailAmount;
    ...
    public boolean equals(Object that) {
        ...
        BLanLnciBaseAcctVo other = (BLanLnciBaseAcctVo) that;
