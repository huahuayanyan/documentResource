 ...
 */
var mortgageMntProtocolController = function($scope,$common,$state,dataDeliver) {
    $scope.protocolForm = {productId:"1220010"};
    ...
    $scope.$watch("conf.pageNo+conf.pageSize",function() {
     ...
     $scope.queryProtocolInfo = function() {
        var dataItemsDO = {productId:"1220010"};
        var data = {
            pageNo: $scope.conf.pageNo,
            pageSize: $scope.conf.pageSize,
            monitorProtocol:  dataItemsDO,
            parentId: "1000"
        }
    ...
    $scope.productSource = function (){
        //业务品种下拉框
        var dataItemsDO = {parentId:"1000",productId:"1220010"};
    ...
    $scope.add_onClick = function(){
        $common.get_ngDialog('mortgageMonitorProtocolMng/scnt_mntProtocol.html', $scope,["$scope",function(dialogScope){
            ...
            dialogScope.otherprotocolNoList = {
                ...
                param:{ productId:"1220010",protocolType:"02"},//请求参数,如果不写该属性或者param:{},则以输入当前字段查询
                split:"-",//分隔符
    ...
    $scope.protocolList_onClick = function(){
    	if($scope.selected.select.length != 1){
    		...
    		var  bCrrGntyCon = {vidPrdId:"1220010", prtclNo:$scope.selected.select[0].protocolCode, conStat:"1"};
	    /*    var  bCrrGntyCon = { conStat:"1"};*/
        ...
        if ($scope.selected.select.length != 1) {
            ...
            $common.get_ngDialog('mortgageMonitorProtocolMng/scnt_mntProtocol.html',$scope,["$scope",function(dialogScope){
                ...
                dialogScope.otherprotocolNoList = {
                    type:"table",//展示类型table  tree
                    url:"fourProtocolService/getFranchiserProtocolQueryByMap",//请求url
                    param:{ productId:"1220010",protocolType:"01"},//请求参数,如果不写该属性或者param:{},则以输入当前字段查询
                    split:"-",//分隔符
                    extentColumn:"protocolCode",
                    column:["protocolCode"]//展示内容
                };
