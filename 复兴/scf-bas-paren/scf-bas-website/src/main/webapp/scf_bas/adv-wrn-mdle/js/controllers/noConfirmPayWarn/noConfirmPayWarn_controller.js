...
//押品流水查询
var NoConfirmPayWarnController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("bNoConfirmPayWarnService/findNoConfirmPayWarnByPage", data);
    ...
    $scope.rebort_onClick = function () {
        $scope.$apply(function(){
            $scope.conditionForm = {};
            $scope.selected.select=[];
            $scope.conditionForm.warehouseType='02';
        })
        $scope.queryTable();
    };
