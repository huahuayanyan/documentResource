...
var invoiceFinancingApplyController = function($scope,$common,$state,dataDeliver) {
	...
	$scope.queryTable = function(paramData){
		...
		var promise = $common.get_asyncData("bLanApproveFindService/findInvoiceFinancingApply",data);
