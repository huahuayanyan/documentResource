 ...
 * Create at:   2016/4/21
 */
var threeConfirmApplyController = function($scope,$common,dataDeliver,$state,$eventCommunicationChannel) {
    $scope.otherform = dataDeliver.getter();
    var appno = $scope.otherform.appno;
    var process="ThreeAccountConfirmApply";// 担保提货收款确认
    queryTaskInfo();//任务信息
    //获取任务信息
    ...
    $state.go("threeConfirmApply.dtl");
