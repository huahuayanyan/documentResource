 ...
 */
var crmAnalylistController = function($scope,$common,dataDeliver,$state,$eventCommunicationChannel) {
    ...
    $scope.queryTable = function(paramData){
        var data= {
            ...
            custAnalysisInfo:$scope.conditionForm
        };
        var promise = $common.get_asyncData("iCoopPartnerMngService/findCrmAnalyListByPage",data);
...
/*    //新增
    ...
    $scope.deleterel_onClick = function(){
        if($scope.selected.select.length != 1){
        	...
        	var data ={
                custAnalysisInfo:$scope.selected.select[0]
        	};
            $common.get_tipDialog('确定删除吗！','showTip').then(function(){
                var primise = $common.get_asyncData('iCoopPartnerMngService/deleteCustRelCrmAnaly',data);
