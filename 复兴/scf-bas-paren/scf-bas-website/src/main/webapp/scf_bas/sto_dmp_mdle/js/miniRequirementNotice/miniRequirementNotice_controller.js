...
//押品流水查询
var miniRequirementNoticeController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("quantityNoticeBaseInfoService/getNoticeBaseInfo", data);
