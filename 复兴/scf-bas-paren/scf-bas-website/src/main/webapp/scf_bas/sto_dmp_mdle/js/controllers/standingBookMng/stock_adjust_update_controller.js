...
var stockAdjustUpdateController = function($scope,$common,dataDeliver,$state,$compile,$eventCommunicationChannel) {
    ...
    $scope.save_onClick = function(){
    	if($.doValidate("otherform")) {
    		var bPbcMtgBaseInfoDO = $scope.otherform;
                var primise = $common.get_asyncData("bCntStockAdjustService/updateStockAdjust",{bPbcMtgBaseInfoDO: bPbcMtgBaseInfoDO});
            primise.then(function (res) {
                if (res.errorCode == "SUC") {
