 ...
 */
var recoverListController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    ...
    $scope.queryTable = function(){
        ...
        var promise = $common.get_asyncData("bIcrInfoService/findBIcrInfoRecoverByPage",data);
