var conInfoTab1Controller = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    ...
    $scope.queryBaseInfo = function(){
        var data= {
            debtContno:obj.debtContno
        };
        var promise = $common.get_asyncData("conMngQryService/queryDebtConByNo",data);
...
//借据信息
    ...
    $scope.queryOverData = function(){
        var data= {
            ...
            paramMap: {debtContno_Q:obj.debtContno,sellerCustcd_Q:obj.cname,factType:"1"}
        };
