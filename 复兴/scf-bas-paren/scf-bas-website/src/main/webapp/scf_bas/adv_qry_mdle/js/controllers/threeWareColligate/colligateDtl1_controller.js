...
var baseInfoController = function($scope,$common,dataDeliver,$state,$compile,$eventCommunicationChannel) {
    ...
    $scope.queryBaseInfo = function(){
        ...
        var promise = $common.get_asyncData("threeWareColligateService/getColligateInfo",data);
        promise.then(function(res){
            if (res.errorCode =="SUC"){
                ...
                $scope.otherform.cname= obj.info.cname;
                $scope.otherform.coreName= obj.info.coreName;
   ...
   //信贷合同
    $scope.queryCreditData = function(){
        ...
        var promise = $common.get_asyncData("threeWareColligateService/getContBaseInfoListBySlaveContno",data);
        promise.then(function(res){
            var data;
            if (res.errorCode =="SUC"){
...
//借据信息
    $scope.queryLnciData = function(){
        ...
        var promise = $common.get_asyncData("threeWareColligateService/getThreeWareLnciList",data);
        promise.then(function(res){
            var data;
            if (res.errorCode =="SUC"){
                data = res.contextData;
