 ...
 */
var deliveryListController = function($scope,$common,dataDeliver,$state,$eventCommunicationChannel) {
    ...
    $scope.queryTable = function(paramData){
        ...
        var promise = $common.get_asyncData("billNormalDeliveryApplyService/BillNormalDeliverableListGetter",data);
