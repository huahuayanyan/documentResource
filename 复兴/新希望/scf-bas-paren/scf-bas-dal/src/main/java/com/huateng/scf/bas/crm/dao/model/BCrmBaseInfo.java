...
public class BCrmBaseInfo implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getCustcd() == null ? other.getCustcd() == null : this.getCustcd().equals(other.getCustcd()))
				...
				&& (this.getSocCreditNo() == null ? other.getSocCreditNo() == null
						: this.getSocCreditNo().equals(other.getSocCreditNo()))
				&& (this.getLicenseNo() == null ? other.getLicenseNo() == null
						: this.getLicenseNo().equals(other.getLicenseNo()))
				&& (this.getLicenseDate() == null ? other.getLicenseDate() == null
						: this.getLicenseDate().equals(other.getLicenseDate()))
				&& (this.getOpenDate() == null ? other.getOpenDate() == null
						: this.getOpenDate().equals(other.getOpenDate()))
				&& (this.getCoreOpenDate() == null ? other.getCoreOpenDate() == null
						: this.getCoreOpenDate().equals(other.getCoreOpenDate()))
				&& (this.getCustStatus() == null ? other.getCustStatus() == null
						: this.getCustStatus().equals(other.getCustStatus()))
				&& (this.getMgrno() == null ? other.getMgrno() == null : this.getMgrno().equals(other.getMgrno()))
				&& (this.getCoreFlag() == null ? other.getCoreFlag() == null
						: this.getCoreFlag().equals(other.getCoreFlag()))
				&& (this.getMoniFlag() == null ? other.getMoniFlag() == null
						: this.getMoniFlag().equals(other.getMoniFlag()))
				&& (this.getFuturesFlag() == null ? other.getFuturesFlag() == null
						: this.getFuturesFlag().equals(other.getFuturesFlag()))
				&& (this.getFlcFlag() == null ? other.getFlcFlag() == null
						: this.getFlcFlag().equals(other.getFlcFlag()))
				...
				&& (this.getBlackFlag() == null ? other.getBlackFlag() == null
						: this.getBlackFlag().equals(other.getBlackFlag()))
				&& (this.getInsureFlag() == null ? other.getInsureFlag() == null
						: this.getInsureFlag().equals(other.getInsureFlag()))
				&& (this.getFactorFlag() == null ? other.getFactorFlag() == null
						: this.getFactorFlag().equals(other.getFactorFlag()))
				&& (this.getCcmsCustcd() == null ? other.getCcmsCustcd() == null
						: this.getCcmsCustcd().equals(other.getCcmsCustcd()))
				&& (this.getImportantFlag() == null ? other.getImportantFlag() == null
						: this.getImportantFlag().equals(other.getImportantFlag()))
				&& (this.getCommercialFalg() == null ? other.getCommercialFalg() == null
						: this.getCommercialFalg().equals(other.getCommercialFalg()))
				&& (this.getOverseasFlag() == null ? other.getOverseasFlag() == null
						: this.getOverseasFlag().equals(other.getOverseasFlag()))
				&& (this.getBanksCustFlag() == null ? other.getBanksCustFlag() == null
						: this.getBanksCustFlag().equals(other.getBanksCustFlag()))
				&& (this.getEfBuyerFlag() == null ? other.getEfBuyerFlag() == null
						: this.getEfBuyerFlag().equals(other.getEfBuyerFlag()))
				&& (this.getIfSellerFlag() == null ? other.getIfSellerFlag() == null
						: this.getIfSellerFlag().equals(other.getIfSellerFlag()))
				&& (this.getIsBank() == null ? other.getIsBank() == null : this.getIsBank().equals(other.getIsBank()))
				&& (this.getFciCode() == null ? other.getFciCode() == null
						: this.getFciCode().equals(other.getFciCode()))
