...
public class ThreeProtocolVO implements Serializable{
	...
	private String updateState;//协议更新状态
	private String updateDate;//协议更新状态
	...
	/**
	 * @param sellOffFlag the sellOffFlag to set
	 */
	...
	/**
	 * @param priceDropRate the priceDropRate to set
	 */
