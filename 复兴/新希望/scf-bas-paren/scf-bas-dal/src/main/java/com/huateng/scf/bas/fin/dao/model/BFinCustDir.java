 ...
 * mengjiajia		2016年11月12日上午9:55:51	     新增
 *
 * </pre>
 */
public class BFinCustDir implements Serializable {
    ...
    private String finPd;//报表周期,01-月报；04-年报；03-半年报
    private String rptNo;//报表期次
