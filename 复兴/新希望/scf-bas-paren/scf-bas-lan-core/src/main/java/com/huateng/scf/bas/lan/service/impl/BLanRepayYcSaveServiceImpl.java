...
import com.huateng.scf.bas.lan.service.IBLanRepayYcSaveService;
 ...
 */
@ScubeService
@Service("BLanRepayYcServiceImpl")
public class BLanRepayYcSaveServiceImpl implements IBLanRepayYcSaveService{
	...
	@Override
	@Transactional
	public void saveYc(BCrrDueBillDetail bCrrDueBillDetail, List<BLanLnciBuyBiz> list) {
