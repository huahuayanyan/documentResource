...
var fourPledgePriceController = function($scope,$common,$state,dataDeliver) {
    ...
    $scope.check_onClick = function(){
        if ($scope.selected.select.length != 1) {
          ...
          $common.get_ngDialog('qualityApply/mortgagePrice.html',$scope,["$scope",function(dialogScope){
              ...
              dialogScope.bindMarketPrice_onClick=function () {
                  $common.get_ngDialog('qualityApply/mortgagePriceList.html',$scope,["$scope",function(dialogScope2){
