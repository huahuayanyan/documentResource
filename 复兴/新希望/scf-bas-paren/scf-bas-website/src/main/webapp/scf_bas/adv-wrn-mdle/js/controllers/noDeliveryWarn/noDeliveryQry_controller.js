...
//押品流水查询
var NoDeliveryWarnController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("bMatureNoDeliveryWarnService/queryNoDeliveryWarningByPage", data);
    ...
    $scope.rebort_onClick = function () {
        $scope.$apply(function(){
            $scope.conditionForm = {};
            $scope.selected.select=[];
            $scope.conditionForm.productId_Q='2';
        })
        $scope.queryTable();
    };
