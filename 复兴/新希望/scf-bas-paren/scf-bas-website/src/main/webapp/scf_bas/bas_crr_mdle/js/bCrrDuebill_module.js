	...
	var routeArry=[
		{
			...
			'url':'/duebill_list',
			'default':'true',
			'templateUrl':'../html/duebill/duebill_list.html',
			'controller':'duebilllistController'
		},
		{
			'state':'duebillapp',
			'url':'/duebillapp',
		...
		},
		{
			...
			'url':'/duebillappedit',
			'templateUrl':'../html/duebill/duebill_edit.html',
			'controller':'duebilleditController'
		},
		{
			'state':'duebillapp.lcedit',
			'url':'/duebillapplcedit',
			'templateUrl':'../html/duebill/duebill_lcedit.html',
			'controller':'duebilleditController'
		},
		{
			'state':'duebillapp.ycedit',
			'url':'/duebillappycedit',
			'templateUrl':'../html/duebill/duebill_ycedit.html',
			'controller':'duebilleditController'
		},
		{
