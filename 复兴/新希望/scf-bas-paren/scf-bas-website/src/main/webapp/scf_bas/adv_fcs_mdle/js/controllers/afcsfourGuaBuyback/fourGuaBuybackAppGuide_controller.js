 ...
 * Create at:   2016/4/21
 */
var fourGuaBuybackAppGuideController = function($scope,$common,dataDeliver,$state,$eventCommunicationChannel) {
    $scope.otherform = {};
    var bdata = window.parent.data;
    var appno = window.parent.appNo;
   var process= window.parent.modelId;// 流程modelId
    queryTaskInfo();//任务信息
    //获取任务信息
