...
var debtExtSelectController = function(dialogScope,parentScope,$common,dataDeliver,flag) {
  ...
  // 查询买方客户
    ...
    dialogScope.confirm_onClick = function(){
        ...
        //赋值到上一个页面的交易对手基本信息
        //parentScope.debtExtdatasource.ds=[];
       // parentScope.debtExtdatasource.ds = dialogScope.selectedDialog.select;
        //parentScope.debtExtdatasource.ds = $common.copy(dialogScope.selectedDialog.select);
