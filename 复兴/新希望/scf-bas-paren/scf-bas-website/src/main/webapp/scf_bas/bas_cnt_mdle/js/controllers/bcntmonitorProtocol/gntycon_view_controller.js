 ...
 */
var viewController = function($scope,$common,dataDeliver,$state,$rootScope) {
    //$scope.otherform = dataDeliver.getter();
    $scope.row = dataDeliver.getter();
    $scope.cache = "0";
    var flag = $scope.row.flag;
    var bCrrGntyCon = $scope.row.bCrrGntyCon;
    if(flag=="view")
    {
        $scope.disable = true;
        $scope.hide = true;
    ...
    $scope.prtclNoContent = {
        ...
        param:{productId:$scope.row.vidPrdId},
        split:",",//分隔符
    ...
    $scope.closeThisDialog_onClick = function(){
       /* var  bCrrGntyCon = {prtclNo: $scope.selected.select[0].protocolCode, vidPrdId: "1220020", conStat:"1"};*/
