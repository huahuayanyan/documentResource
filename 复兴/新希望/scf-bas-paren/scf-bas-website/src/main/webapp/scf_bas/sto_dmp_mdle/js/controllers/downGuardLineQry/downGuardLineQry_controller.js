...
//押品流水查询
var DownGuardLineQryController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("bDownLowPriceService/queryDownLowPriceNewByPage", data);
    ...
    $scope.rebort_onClick = function () {
        $scope.$apply(function(){
            $scope.conditionForm = {};
            $scope.selected.select=[];
            $scope.conditionForm.warnNo_Q ='122002002';
        })
        $scope.queryTable();
    };
