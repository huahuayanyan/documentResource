 ...
 */
var quantityNoticeBaseInfoController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    $scope.conditionForm={
        bussType:"1220010",//业务品种默认值
        noticeType:"90"//现货出质入库通知书
    };//初始化查询条件对象
    //业务品种
    $scope.productSource = {
        ds:[{productKey:"1220010",productValue:'现货静态质押'},]
    };
    //通知书类型
    $scope.noticeSource = {
        ds:[{noticeKey:"90",noticeValue:'现货出质入库通知书'},]
    };
