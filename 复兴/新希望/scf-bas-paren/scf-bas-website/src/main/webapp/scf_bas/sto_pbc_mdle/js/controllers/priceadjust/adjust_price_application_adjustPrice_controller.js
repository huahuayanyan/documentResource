	    ...
	    $scope.datasource={//初始化表格对象
	     ...
	     /*   if(!$scope.taskform)
	        ...
	        $scope.add_onClick = function(){
	            $common.get_ngDialog('priceadjust/adjustPriceApplicationAdjustPriceAdd.html', $scope
	                    ...
	                    dialogScope.queryTable = function(){
	                        ...
	                        promise.then(function (res) {
	                            if(res.errorCode=="SUC"){
	                                ...
	                                var len = dialogScope.datasourceDialog.ds.length;
	                                for(var i =0;i<len;i++){
	                                	for(var j=0;j<$scope.datasource.ds.length;j++){
	                                		if(dialogScope.datasourceDialog.ds[i].mortgageNo == $scope.datasource.ds[j].mortgageNo)
	                                			dialogScope.datasourceDialog.ds[i].selected;
	                                	}
	        ...
	        $scope.update_onClick = function(){
	            if($scope.selected.select.length != 1){
	                ...
	                $common.get_ngDialog('priceadjust/adjustPriceApplicationAdjustPriceUpdate.html', $scope
	                    , ["$scope", function (dialogScope) {
	        ...
	        $scope.save_onClick = function()
	        {
	            ...
	            if($.doValidate("otherform")) {
	                ...
	                $scope.otherform.productId='1220010';
