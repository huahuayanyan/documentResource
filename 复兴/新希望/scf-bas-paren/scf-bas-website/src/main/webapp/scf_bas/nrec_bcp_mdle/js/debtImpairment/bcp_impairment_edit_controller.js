 ...
 */
var nrecBcpImpairmentEditController = function($scope,$common,dataDeliver,$state,$eventCommunicationChannel) {
    ...
    $scope.$on('interceptEvent',function(event,data) {
        ...
        var primise = $common.get_asyncData("ndebtImpairmentService/FactoringAllowanceAddSave",data);
