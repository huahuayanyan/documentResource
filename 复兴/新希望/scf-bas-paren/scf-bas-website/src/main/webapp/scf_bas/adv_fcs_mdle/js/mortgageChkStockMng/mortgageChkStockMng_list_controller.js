...
//押品流水查询
var mortgageChkStockMngListController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("mortgageChkStockMngService/queryCheckStockByPage", data);
    ...
    $scope.addBtn_onClick = function(){
        ...
        $state.go("mortgageChkStockMngQry");
    };
