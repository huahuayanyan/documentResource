var conController = function($scope,$common,dataDeliver,$state,$compile,$eventCommunicationChannel) {
    /**合同基本信息 开始**/
    $scope.otherform={};
    $scope.selectbrNo={}; //机构
...
//费用查看
    $scope.column = function(row){
        ...
        $common.get_ngDialog('debtPoolGenerate/costInfoMod.html',$scope
