 ...
 */
var monGntyconeditController = function($scope,$common,dataDeliver,$state,$rootScope) {
    ...
    $scope.addmort_onClick = function(){
        if($.doValidate("row")) {
            $common.get_ngDialog('../../../scf_bas/bas_cnt_mdle/html/bcrrlncon/mort_edit.html', $scope,["$scope",function(dialogScope){
                dialogScope.mort = {};
    ...
    $scope.addins_onClick = function(){
        if($.doValidate("row")) {
            $common.get_ngDialog('../../../scf_bas/bas_cnt_mdle/html/bcrrlncon/insurance_edit.html', $scope,["$scope",function(dialogScope){
                dialogScope.ins = {};
