...
(function(){
    ...
    var routeArry=[
        {
            'state':'checkTransfer',
            'url':'/checkTransfer',
            'templateUrl':'appli/checkTransfer.html',
            'controller':'CheckTransferController'
        },
        {
            'state':'checkTransferApply',
            'url':'/checkTransferApply',
            'templateUrl':'appli/checkTransferApply.html',
            'controller':'CheckTransferApplyController'
        },
        {
            'state':'bcpBaseInfo',
            'url':'/bcpBaseInfo',
            'templateUrl':'appli/bcpBaseInfo.html',
    ...
    scubeUI.module('rbcp_info_apply_mdle',dependency,routeArry);
    //手动拉起angular应用程序
