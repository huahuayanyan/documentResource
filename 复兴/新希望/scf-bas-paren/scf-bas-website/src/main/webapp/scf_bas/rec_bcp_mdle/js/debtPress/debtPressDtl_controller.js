 ...
 */
var debtPressDtlController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    ...
    var process="DebtPressingApply";// 应收账款融资催收申请
   ...
   $scope.delete_onClick = function() {
    ...
    $scope.sumbit_onClick = function(){
        if($.doValidate("otherform")) {
            ...
            primise.then(function (res) {
                if (res.errorCode == "SUC") {
                    if($state.current.name=="debtPressDtlApp") {
                        $scope.viewhide=true;
                        $scope.hideback=true;
                    }else{
