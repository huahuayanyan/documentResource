...
var checkStockDtlController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    ...
    $scope.queryTable = function(){
        ...
        var promise1 = $common.get_asyncData("fourCheckStockService/fourCheckStockDebtSum",data1);
    ...
    $scope.save_onClick = function(){
        if($.doValidate("baseInfo")) {
            ...
            var primise = $common.get_asyncData("fourCheckStockService/fourCheckStockVerify", data);
