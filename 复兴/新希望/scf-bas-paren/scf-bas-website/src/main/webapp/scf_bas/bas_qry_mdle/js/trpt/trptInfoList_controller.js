 ...
 */
var trptInfoListController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    $scope.conditionForm={
        factType:"1",//应收账款
    ...
    $scope.queryTable = function(){
        ...
        var promise = $common.get_asyncData("bQryTripartiteDeliveryInfoService/findThreeLnciInfoQuery",data);
