 ...
 * Create at:   2017/1/12
 */
var paymentPoolApplyController =  function($scope,$common,dataDeliver,$state,$eventCommunicationChannel){
    ...
    //获得之前得到的卖方客户号去查询  业务合同号，业务品种名称和id，对应的合同的币种
       ...
       $scope.debtContnoContent = {
            ...
            param:{custcd:$scope.otherform.custcdSaller,factType:"2"},
            split:"",//分隔符*/
        ...
        if($.doValidate("otherform")){
            ...
            primise.then(function(res){
                if (res.errorCode =="SUC"){
                    ...
                    $state.go("paymentpoolupdate",{appNo:data.value});
