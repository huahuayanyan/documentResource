...
public class BPbcMtgClass implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        BPbcMtgClass other = (BPbcMtgClass) that;
        return (this.getMortgageCode() == null ? other.getMortgageCode() == null : this.getMortgageCode().equals(other.getMortgageCode()))
            ...
            && (this.getRevaluationInterval() == null ? other.getRevaluationInterval() == null : this.getRevaluationInterval().equals(other.getRevaluationInterval()))
