...
public class NoticeQryVO implements Serializable {
	 ...
	 * 通知书类型
	 */
	private List<String> noticeTypeSet;
	 ...
	 * 申请日期 从
	 */
	private String appliDateFrom;
	/**
	 * CHAR(8)<br>
	 * 申请日期 到
	 */
	private String appliDateTo;
	...
	public String getAppliDateFrom() {
		return appliDateFrom;
	}

	public void setAppliDateFrom(String appliDateFrom) {
		this.appliDateFrom = appliDateFrom;
	}

	public String getAppliDateTo() {
		return appliDateTo;
	}

	public void setAppliDateTo(String appliDateTo) {
		this.appliDateTo = appliDateTo;
	}
	...
	public List<String> getNoticeTypeSet() {
		return noticeTypeSet;
	}

	public void setNoticeTypeSet(List<String> noticeTypeSet) {
		this.noticeTypeSet = noticeTypeSet;
	}
