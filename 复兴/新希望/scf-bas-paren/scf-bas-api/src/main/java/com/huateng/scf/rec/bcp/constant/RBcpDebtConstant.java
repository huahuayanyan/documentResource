 ...
 * 
 */
package com.huateng.scf.rec.bcp.constant;
 ...
 * huangshuidan		   2016年12月16日下午5:31:46              新增
 *
 *            </pre>
 */
public class RBcpDebtConstant extends ScfBasConstant{

	public static final String R_BCP_DEBT_APPLY_NO = "R_BCP_DEBT_APPLY_NO";// 应收账款基本信息申请流水号
	public static final String R_BCP_DEBT_DTL_APPLY_NO = "R_BCP_DEBT_DTL_APPLY_NO";// 应收账款单据明细表流水号
	public static final String R_BCP_BUSS_APP_NO = "R_BCP_BUSS_APP_NO";// 应收账款单据明细表流水号
	// 商纠次数0
	public static final Integer R_BCP_ISSUETIMES = 0;// 商纠次数0
	// 锁定状态
	public static final String IS_LOCKED_FALSE = "0";// 未锁定
	public static final String IS_LOCKED_TRUE = "1";// 已锁定
	/*** 发票状态 */
	...
	/** 尾款规则 **/
	public static final String DUE_BALANCE_RULE_TO_ACCOUNT = "01";// 入结算账户
	public static final String DUE_BALANCE_RULE_IN_RETURN_ACCOUNT = "02";// 留存回款专户
	...
	/** 回款核销规则 **/
	public static final String PAYMENT_VERIFY_RULE_DUE_FIRST = "01";// 先到期先核销
	public static final String PAYMENT_VERIFY_RULE_AVERAGE = "02";// 平均分配核销
	...
	public static final String R_BCP_WRITEOFF = "RBcpWriteoff";// 应收账款核销申请
	public static final String R_BCP_WRITEOFF_POOL = "RBcpWriteoffPool";// 应收账款核销申请
	public static final String R_BCP_WRITEOFF_NAME = "应收账款核销申请";// 应收账款核销申请
	public static final String R_BCP_WRITEOFF_POOL_NAME = "应收账款池融资核销申请";// 应收账款池融资核销申请


	public static final String R_BCP_IMPAIRMENT = "RBcpImpairment";// 应收账款减值申请
	public static final String R_BCP_IMPAIRMENT_POOL = "RBcpImpairmentPool";// 应收账款池融资减值申请
	public static final String R_BCP_IMPAIRMENT_NAME = "应收账款减值申请";//应收账款减值申请
	public static final String R_BCP_IMPAIRMENT_POOL_NAME = "应收账款池融资减值申请";//应收账款减值申请

	

	public static final String R_BCP_WRITEOFF_REQUEST = "request";// 核销申请
	public static final String R_BCP_IMPAIRMENT_REQUEST = "request";// 减值申请
