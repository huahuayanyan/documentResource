...
public class NPayMentLanInfo implements Serializable {
	/**
	 * 
	 */
	...
	private  BigDecimal payAmount;//入账金额
	private  BigDecimal repayAmount;//还款金额(流贷)、
	private  BigDecimal amountOver;//尾款金额
	private  BigDecimal avaliableRiskAmt;//信贷合同可用敞口
	private   BigDecimal inTableInt;//表内欠息
    /**
     * VARCHAR(32) 必填<br>
     * 主键UUID
     */
    ...
    public boolean equals(Object that) {
        ...
        NPayMentLanInfo other = (NPayMentLanInfo) that;
	...
	public BigDecimal getInTableInt() {
		return inTableInt;
	}

	public void setInTableInt(BigDecimal inTableInt) {
