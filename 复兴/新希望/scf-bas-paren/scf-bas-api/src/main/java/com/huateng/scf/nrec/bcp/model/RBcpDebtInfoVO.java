...
public class RBcpDebtInfoVO implements Serializable {
	 ...
	 * 有效金额从
	 */
	private BigDecimal billsAmountFrom;
	/**
	 * DECIMAL(16,2)<br>
	 * 有效金额到
	 */
	private BigDecimal billsAmountTo;
	
	public BigDecimal getBillsAmountFrom() {
		return billsAmountFrom;
	}

	public void setBillsAmountFrom(BigDecimal billsAmountFrom) {
		this.billsAmountFrom = billsAmountFrom;
	}

	public BigDecimal getBillsAmountTo() {
		return billsAmountTo;
	}
	 ...
	 * 应收账款到期日
	 */
	private String debtEndFrom;
	/**
	 * CHAR(8)<br>
	 * 应收账款到期日
	 */
	private String debtEndTo;
	...
	public String getDebtEndFrom() {
		return debtEndFrom;
	}

	public void setDebtEndFrom(String debtEndFrom) {
		this.debtEndFrom = debtEndFrom;
	}

	public String getDebtEndTo() {
		return debtEndTo;
	}

	public void setDebtEndTo(String debtEndTo) {
		this.debtEndTo = debtEndTo;
	}
	...
	/**
	 * CHAR(1)<br>
	 * 保理业务类别(国内保理 反向保理 信保融资 应收账款质押 保理池融资 出口退税池质押融资 出口保理)
	 */
	...
	/**
	 * CHAR(1)<br>
	 * 获得 保理业务类别(国内保理 反向保理 信保融资 应收账款质押 保理池融资 出口退税池质押融资 出口保理)
	 */
	...
	/**
	 * CHAR(1)<br>
	 * 设置 保理业务类别(国内保理 反向保理 信保融资 应收账款质押 保理池融资 出口退税池质押融资 出口保理)
	 */
	...
	public boolean equals(Object that) {
		...
		RBcpDebtInfoVO other = (RBcpDebtInfoVO) that;
