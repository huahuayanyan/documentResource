...
public class BLanLnciBase implements Serializable {
	...
	private BigDecimal totCashEqualAmt;
	...
	public boolean equals(Object that) {
		...
		return (this.getDebetNo() == null ? other.getDebetNo() == null : this.getDebetNo().equals(other.getDebetNo()))
				...
				&& (this.getLoansChargeOrder() == null ? other.getLoansChargeOrder() == null
						: this.getLoansChargeOrder().equals(other.getLoansChargeOrder()))
				...
				&& (this.getReceivableAccuredInt() == null ? other.getReceivableAccuredInt() == null
						: this.getReceivableAccuredInt().equals(other.getReceivableAccuredInt()))
				&& (this.getCollectionAccuredInt() == null ? other.getCollectionAccuredInt() == null
						: this.getCollectionAccuredInt().equals(other.getCollectionAccuredInt()))
				...
				&& (this.getReceivableAccuredPint() == null ? other.getReceivableAccuredPint() == null
						: this.getReceivableAccuredPint().equals(other.getReceivableAccuredPint()))
				&& (this.getCollectionAccuredPint() == null ? other.getCollectionAccuredPint() == null
						: this.getCollectionAccuredPint().equals(other.getCollectionAccuredPint()))
				&& (this.getReceivablePunishInt() == null ? other.getReceivablePunishInt() == null
						: this.getReceivablePunishInt().equals(other.getReceivablePunishInt()))
				&& (this.getCollectionPunishInt() == null ? other.getCollectionPunishInt() == null
						: this.getCollectionPunishInt().equals(other.getCollectionPunishInt()))
				&& (this.getAccuredCompountInt() == null ? other.getAccuredCompountInt() == null
						: this.getAccuredCompountInt().equals(other.getAccuredCompountInt()))
				&& (this.getCompoundInt() == null ? other.getCompoundInt() == null : this.getCompoundInt().equals(other.getCompoundInt()))
				&& (this.getAccuredDiscountInt() == null ? other.getAccuredDiscountInt() == null
						: this.getAccuredDiscountInt().equals(other.getAccuredDiscountInt()))
				&& (this.getReceivableDiscountInt() == null ? other.getReceivableDiscountInt() == null
						: this.getReceivableDiscountInt().equals(other.getReceivableDiscountInt()))
				&& (this.getDeferredInt() == null ? other.getDeferredInt() == null : this.getDeferredInt().equals(other.getDeferredInt()))
				&& (this.getVerifiedCapital() == null ? other.getVerifiedCapital() == null
						: this.getVerifiedCapital().equals(other.getVerifiedCapital()))
				...
				&& (this.getMaintenanceDate() == null ? other.getMaintenanceDate() == null
						: this.getMaintenanceDate().equals(other.getMaintenanceDate()))
				&& (this.getMaintenanceTlrno() == null ? other.getMaintenanceTlrno() == null
						: this.getMaintenanceTlrno().equals(other.getMaintenanceTlrno()))
				&& (this.getCancellationDate() == null ? other.getCancellationDate() == null
						: this.getCancellationDate().equals(other.getCancellationDate()))
				&& (this.getCancellationTlrno() == null ? other.getCancellationTlrno() == null
						: this.getCancellationTlrno().equals(other.getCancellationTlrno()))
				...
				&& (this.getHasIndirectCredit() == null ? other.getHasIndirectCredit() == null
						: this.getHasIndirectCredit().equals(other.getHasIndirectCredit()))
	...
	public BigDecimal getTotBailAmt() {
		return (this.bailAmount == null ? BigDecimal.ZERO : this.bailAmount.add(this.addBailAmount == null ? BigDecimal.ZERO : this.addBailAmount));
	}

	public BigDecimal getTotCashEqualAmt() {
		return (this.initCashEqtAmt == null ? BigDecimal.ZERO
				: this.initCashEqtAmt.add(this.addCashEqtAmt == null ? BigDecimal.ZERO : this.addCashEqtAmt));
	}

	public void setTotCashEqualAmt(BigDecimal totCashEqualAmt) {
		this.totCashEqualAmt = totCashEqualAmt;
	}

	public void setTotBailAmt(BigDecimal totBailAmt) {
