package com.huateng.scf.bas.acc.model;
...
public class BAccAccountInfo extends ScfBaseModel implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				...
				&& (this.getMyBankAccFlg() == null ? other.getMyBankAccFlg() == null : this.getMyBankAccFlg().equals(other.getMyBankAccFlg()))
				&& (this.getOpenAccBankNm() == null ? other.getOpenAccBankNm() == null : this.getOpenAccBankNm().equals(other.getOpenAccBankNm()))
				&& (this.getOpenAccBankNo() == null ? other.getOpenAccBankNo() == null : this.getOpenAccBankNo().equals(other.getOpenAccBankNo()))
