...
public interface INBNteNoticeBaseService {
	public static final String BEAN_ID = "nbNteNoticeBaseService";
	 ...
	 * @throws ScubeBizException
	 * @author 	mengjiajia
	 * @date 	2017年6月5日下午3:04:15
	 */
	public void addNoticeAllowanceByAppno(@ScubeParam("bussAppno") String bussAppno,@ScubeParam("factType") String factType) throws ScubeBizException;
}
