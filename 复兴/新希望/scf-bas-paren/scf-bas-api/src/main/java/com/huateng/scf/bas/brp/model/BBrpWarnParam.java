...
public class BBrpWarnParam implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getWarnNo() == null ? other.getWarnNo() == null : this.getWarnNo().equals(other.getWarnNo()))
				&& (this.getWarnName() == null ? other.getWarnName() == null
						: this.getWarnName().equals(other.getWarnName()))
				&& (this.getWarnType() == null ? other.getWarnType() == null
						: this.getWarnType().equals(other.getWarnType()))
				&& (this.getSuspendFlag() == null ? other.getSuspendFlag() == null
						: this.getSuspendFlag().equals(other.getSuspendFlag()))
				&& (this.getSuspendDay() == null ? other.getSuspendDay() == null
						: this.getSuspendDay().equals(other.getSuspendDay()))
				&& (this.getTargetType() == null ? other.getTargetType() == null
						: this.getTargetType().equals(other.getTargetType()))
				&& (this.getTargetBrclass() == null ? other.getTargetBrclass() == null
						: this.getTargetBrclass().equals(other.getTargetBrclass()))
				&& (this.getTargetRoleid() == null ? other.getTargetRoleid() == null
						: this.getTargetRoleid().equals(other.getTargetRoleid()))
				&& (this.getPackageId() == null ? other.getPackageId() == null
						: this.getPackageId().equals(other.getPackageId()))
				&& (this.getWarnProcess() == null ? other.getWarnProcess() == null
						: this.getWarnProcess().equals(other.getWarnProcess()))
				&& (this.getWarnLevelLow() == null ? other.getWarnLevelLow() == null
						: this.getWarnLevelLow().equals(other.getWarnLevelLow()))
				&& (this.getWarnLevelMidi() == null ? other.getWarnLevelMidi() == null
						: this.getWarnLevelMidi().equals(other.getWarnLevelMidi()))
				&& (this.getWarnLevelHigh() == null ? other.getWarnLevelHigh() == null
						: this.getWarnLevelHigh().equals(other.getWarnLevelHigh()))
				&& (this.getWarnBussType() == null ? other.getWarnBussType() == null
						: this.getWarnBussType().equals(other.getWarnBussType()))
