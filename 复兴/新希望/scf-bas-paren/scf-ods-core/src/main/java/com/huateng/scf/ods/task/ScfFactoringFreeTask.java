 ...
 * huangshuidan		   2017年6月7日上午9:52:31             新增
 *
 * </pre>
 */
public class ScfFactoringFreeTask {
	...
	public TaskExecResult handle(TaskExecContext context) {
		...
		try {
			...
			String[] params = { "", "" }; // 传递参数
			this.runJob(uitls.getConn(), params, "scf-factoring-free-job", "/ODS_DEBT");
		} catch (Exception e) {
...
//			job.setVariable("value", params[1]);
	...
	public static void main(String[] args) throws Exception {
		...
		String[] params = { "", "" }; // 传递参数
		//执行job
		new ScfFactoringFreeTask().runJob(uitls.getConn(), params, "scf-factoring-free-job", "/ODS_DEBT");
