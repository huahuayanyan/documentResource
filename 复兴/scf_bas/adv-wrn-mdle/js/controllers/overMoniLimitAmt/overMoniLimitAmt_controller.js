...
//押品流水查询
var OverMoniLimitAmtController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        var data = {
            ...
            downLowPriceNewQryVO: $scope.conditionForm
        };

        var promise = $common.get_asyncData("bOverMoniLimitWrnService/queryOverMoniLimitWrnByPage", data);
