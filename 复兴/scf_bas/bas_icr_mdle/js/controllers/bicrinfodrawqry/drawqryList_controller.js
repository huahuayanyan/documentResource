 ...
 */
var drawqryListController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    ...
    $scope.queryTable = function(){
        ...
        var promise = $common.get_asyncData("bIcrInfoService/findBIcrDrawInfoListByPage",data);
