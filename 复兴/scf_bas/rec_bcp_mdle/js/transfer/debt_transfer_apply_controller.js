 ...
 */
var DebtTransferApplyController = function($scope,$common,$state,dataDeliver,$eventCommunicationChannel) {
    ...
    $scope.queryForm = function(){
        ...
        promise.then(function(res){
            if (res.errorCode =="SUC"){
                ...
                $scope.otherformX.stratDate=$scope.otherform.purchaseDate;
