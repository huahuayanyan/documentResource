...
var mortgageMntProtocolController = function($scope,$common,$state,dataDeliver) {
    $scope.protocolForm = {productId:"1210020"};
    ...
    $scope.$watch("conf.pageNo+conf.pageSize",function() {
     ...
     $scope.queryProtocolInfo = function() {
        var data = {
            ...
            monitorProtocol:  $scope.protocolForm,
            parentId: "2000"
        }
    ...
    $scope.add_onClick = function(){
        $common.get_ngDialog('mortgageMntProtocol/mntProtocol.html', $scope,["$scope",function(dialogScope){
            ...
            dialogScope.otherprotocolNoList = {
                ...
                param:{ productId:"1210020",protocolType:"02"},//请求参数,如果不写该属性或者param:{},则以输入当前字段查询
                split:"-",//分隔符
            ...
            dialogScope.productId = function(productId) {
                if(productId==1210020){
                    dialogScope.protocolInfo.moniType = "1";
                }else{
    ...
    $scope.protocolList_onClick = function(){
    	if($scope.selected.select.length != 1){
    		...
    		var  bCrrGntyCon = {vidPrdId:"1210020", prtclNo:$scope.selected.select[0].protocolCode, conStat:"1"};
