...
var debtPressNoticeController = function($scope,$common,$state,dataDeliver) {
    ...
    $scope.queryTable = function(paramData){
        if($scope.conditionForm.noticeType==null||$scope.conditionForm.noticeType==''){
            $scope.conditionForm.noticeType = [33,115];//应收账款催收通知书
        }
        ...
        var data= {
            ...
            bNteNoticeBaseCon:{mastContno:mastContno,bussType:vidBusTyp,noticeTypes:noticeType,status:noticeStatus,brcode:jbjg,sallerName:sallerName,
    ...
    $scope.rebort_onClick =function(){
        ...
        $scope.$apply(function(){
            $scope.conditionForm = {noticeTypes:[33,115]};
