...
//差额退款通知书列表
var FourDeliveryNotifyListController = function ($scope, $common, $state, dataDeliver) {
...
//树==上级机构
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("aNteFourDeliveryNotifyService/queryFourDeliveryNotifyListByPage", data);
...
//查看操作！
    $scope.column = function(row){
        $common.get_ngDialog('fourDeliveryNotify/fourDelivery_notify_view_qry.html', $scope
            ,["$scope",function(dialogScope){
                FourDeliveryNotifyViewController(dialogScope,$scope,$common,row);
            }],"发货入库通知书基本信息",{showClose:true});
    };
    //重置按钮
