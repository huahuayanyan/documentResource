...
var invoicePoolFinancingApplyController = function($scope,$common,$state,dataDeliver) {
	...
	$scope.queryTable = function(paramData){
		...
		var promise = $common.get_asyncData("bLanApproveFindService/findInvoicePoolFinancingApply",data);
	...
	$scope.rebort_onClick =function(){
		...
		$scope.conditionForm.debetId = "";
		$scope.conditionForm.status = "";
		$scope.queryTable();
	}
	/**查看详情按钮*/
