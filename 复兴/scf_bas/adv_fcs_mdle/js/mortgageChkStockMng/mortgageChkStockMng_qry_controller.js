...
//押品流水查询
var mortgageChkStockMngQryController = function ($scope, $common, $state, dataDeliver) {
    ...
    $scope.queryTable = function (paramData) {
        ...
        var promise = $common.get_asyncData("mortgageChkStockMngService/queryPclInfoByPage", data);
