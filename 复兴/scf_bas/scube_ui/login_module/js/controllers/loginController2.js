 ...
 * Create at:   2016/5/30
 */
var loginController2 = function($common,$scope,$cookieStore,$cookies,$location){
    /*try {
        //var _href = location.href.split('/');
        //if(_REQUEST_DSSIGN!='mock'){
        //    _HTTP_IP_PORT = _href[0]+"//"+_href[2]+"/"+_href[3]+"/"
        //}
        //var searchObject = $location.search();

        var searchObject = (location.search).slice(1).split("&");
        var msg = searchObject[0].split("=")[1];
        if(msg){
            $common.get_tipDialog(decodeURIComponent(msg),'showError')
        }
    }catch (e){}*/
    var SYSNAME ="";
    $scope.sysName="";
